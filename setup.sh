...
###
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Floriano21/izinvps/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Floriano21/izinvps/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Floriano21/izinvps/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
sleep 2
clear
wget https://raw.githubusercontent.com/Floriano21/multi-ws/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/Floriano21/multi-ws/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
wget https://raw.githubusercontent.com/Floriano21/multi-ws/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
wget https://raw.githubusercontent.com/Floriano21/multi-ws/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/Floriano21/multi-ws/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
### Pasang SlowDNS
...
sleep 2
wget https://raw.githubusercontent.com/Floriano21/multi-ws/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
cat> /root/.profile << END
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Floriano21/multi-ws/main/version  )
